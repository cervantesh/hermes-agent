"""Hash every source file that can affect V6 observations."""
...
FILES = (
    ...
    "shared_context_research_v6/runtime_v6.py",
    "shared_context_research_v6/protocol_v6.py",
    "shared_context_research_v6/fixture_worker_v6.py",
    "shared_context_research_v6/runner_v6.py",
    "shared_context_research_v6/PROTOCOL_FREEZE_V6.md",
)
