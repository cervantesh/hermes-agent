...
| The inherited diagnostic failures have independent ownership | Canonical per-file follow-up on clean main plus causal controls | **confirmed** | `598 passed`, `12 failed`, `42 skipped`, plus one passing file exceeding the 300-second per-file limit; see the [transferable audit receipt](INHERITED_FAILURE_AUDIT.md) and owners [#98037](https://github.com/NousResearch/hermes-agent/issues/98037)–[#98040](https://github.com/NousResearch/hermes-agent/issues/98040). None is caused by this refactor. |
